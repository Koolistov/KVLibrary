#
#  Be sure to run `pod spec lint KVLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                  A longer description of KVLibrary in Markdown format.
  # 
  ...
  # s.authors      = { "Johan Kool" => "johan@koolistov.net", "other author" => "email@address.com" }
  # s.author       = 'Johan Kool', 'other author'
